      ...
      <div className="content-overlay">
        ...
        <main className="max-w-4xl mx-auto px-4 py-8">
          <div className="card bg-white dark:bg-gray-800">
            ...
            <h1 className="text-3xl sm:text-4xl text-center mb-8 text-advent-primary dark:text-advent-secondary">
            ...
            <div className="prose max-w-none">
              ...
              <section className="mb-12">
                <h2 className="text-2xl sm:text-3xl mb-6 text-advent-primary dark:text-advent-secondary">The Two Great Commandments</h2>
              ...
              <section>
                <h2 className="text-2xl sm:text-3xl mb-8 text-advent-primary dark:text-advent-secondary">The Ten Commandments</h2>
                <div className="space-y-8 mt-10">
                  {commandments.map((cmd) => (
                    <div key={cmd.id} className="border-l-4 border-blue-500 dark:border-blue-700 pl-6 py-4 bg-gray-50 dark:bg-gray-700 rounded-r-lg">
                      <h3 className="text-xl sm:text-2xl font-bold text-advent-primary dark:text-advent-secondary mb-3">
                        {cmd.id}. {cmd.text}
                      </h3>
                      ...
                      <div className="bg-white dark:bg-gray-800 p-5 rounded-lg">
                        <h4 className="font-bold text-advent-primary dark:text-advent-secondary mb-3 text-lg">Biblical Reasoning:</h4>
              ...
              <section className="mt-16">
                <h2 className="text-2xl sm:text-3xl mb-6 text-advent-primary dark:text-advent-secondary">The Unity of the Law</h2>
                <p className="text-lg mb-6 text-gray-700 dark:text-gray-300">
                ...
                <div className="bg-red-50 dark:bg-red-950 p-6 rounded-xl mb-8 border-l-4 border-red-500">
                  ...
                  <p className="text-red-700 dark:text-red-300 text-lg">
                    Love, defined as self-sacrifice for the best of others, is not possible without rejoicing in the absence of the cherished sinful thought processes that lead to the transgressions the Ten Commandments forbid. True love does not rejoice in wrongdoing but rejoices with the truth (1 Corinthians 13:6). Therefore, to love truly is to uphold the moral standards God has set forth in His law.
                  </p>
                </div>
                <h2 className="text-2xl sm:text-3xl mt-10 mb-6 text-advent-primary dark:text-advent-secondary">Practical Application</h2>
                <p className="text-lg mb-6 text-gray-700 dark:text-gray-300">
                  Every commandment is an expression of love and mercy from God. They flow as a saving power designed to protect us and secure our well-being, both now and forever.
                </p>
                <p className="text-lg mb-6 text-gray-700 dark:text-gray-300">
