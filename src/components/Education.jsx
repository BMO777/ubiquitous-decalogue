          ...
          <div className="card bg-white dark:bg-gray-800">
            ...
            <div className="prose max-w-none">
              <p className="text-lg mb-8 text-gray-700 dark:text-gray-300">
                ...
                principles spoken out loud for multitudes to hear before being
                given by God to Moses on Mount Sinai. Based on timeless
                principles for the heart's posture, the 10 commandments are
                worthy of human attention and form the foundation of moral and
                spiritual life through reason, tradition, or the written word.
                Obedience to its principles involves the happiness of all, and
                with it the stability, the very foundation and framework, of
                human society.
              </p>
              ...
              <section className="mb-12">
                ...
                <div className="bg-indigo-50 dark:bg-indigo-950 p-6 rounded-xl">
                  ...
                  <p className="text-indigo-700 dark:text-indigo-300 text-lg mb-4">
                    ...
                    4th commandment in God's example at creation. Those who
                    remain faithful to keeping God's commandments like Christ
                    and creation timing demonstrate their loyalty to the Creator
              ...
              <section>
                <h2 className="text-2xl sm:text-3xl mb-8 text-advent-primary dark:text-advent-secondary">
                  ...
                  {commandments.map((cmd) => (
                    ...
                    >
                      ...
                      <div className="bg-white dark:bg-gray-800 p-5 rounded-lg">
                        <h4 className="font-bold text-advent-primary dark:text-advent-secondary mb-3 text-lg">
                          Biblical Reasoning:
                        </h4>
              ...
              <section className="mt-16">
                ...
                <h2 className="text-2xl sm:text-3xl mt-10 mb-6 text-advent-primary dark:text-advent-secondary">
