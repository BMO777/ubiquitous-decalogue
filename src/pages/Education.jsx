          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
            ...
            <div className="prose max-w-none">
              <p className="text-lg text-gray-700 mb-6">
                The Ten Commandments, also known as the Decalogue, are divine principles spoken out loud for multitudes to hear beforebeing given by God to Moses on Mount Sinai. These commandments form the foundation of moral and spiritual life through reason, or tradition, or the written word.
              </p>
