                ...
                <div className="space-y-8 mt-10">
                  {commandments.map((cmd) => (
                    <div key={cmd.id} className="border-l-4 border-blue-500 pl-6 py-4 bg-gray-50 rounded-r-lg">
                      ...
                      <p className="text-gray-700 mb-4 text-lg"><strong>Key Points:</strong> {cmd.keyPoints}</p>
                      <div className="bg-white p-5 rounded-lg">
                        <h4 className="font-bold text-gray-900 mb-3 text-lg">Biblical Reasoning:</h4>
                        <p className="text-gray-700 text-lg">{cmd.analyze("").biblicalReasoning}</p>
                      </div>
                    </div>
                  ))}
                </div>
