...
export const commandments = [
  {
    ...
    analyze(inputText) {
      ...
      return {
        ...
        guidance: "Cultivate daily practices that honor God as supreme, such as prayer, Scripture study, and acts of service that reflect His priorities."
      };
    }
  },
  {
    ...
    analyze(inputText) {
      ...
      return {
        ...
        guidance: "Focus worship on the invisible, incomparable nature of God through spirit and truth, as revealed in Scripture."
      };
    }
  },
  {
    ...
    analyze(inputText) {
      ...
      return {
        ...
        guidance: "Cultivate reverence for God's name through mindful speech and meditation on His majestic character as revealed in Scripture."
      };
    }
  },
  {
    ...
    analyze(inputText) {
      ...
      return {
        ...
        biblicalReasoning: "Exodus 20:8-11 - 'Remember the Sabbath day, to keep it holy.' The Sabbath distinguishes the true God from false gods and is the sign of allegiance to Him.",
        guidance: "Set aside time for worship, rest, and reflection on God's creative and redemptive works, avoiding secular concerns."
      };
    }
  },
  {
    ...
    analyze(inputText) {
      ...
      return {
        ...
        guidance: "Show respect, love, and care for parents through actions and attitudes that reflect honor and gratitude for their role."
      };
    }
  },
  {
    ...
    analyze(inputText) {
      ...
      return {
        ...
        guidance: "Cultivate love for others as yourself, actively seeking their welfare and avoiding all forms of harm, both physical and emotional."
      };
    }
  },
  {
    ...
    analyze(inputText) {
      ...
      return {
        ...
        guidance: "Guard the heart and mind through purity in media consumption, relationships, and personal conduct that honors marriage covenant."
      };
    }
  },
  {
    ...
    analyze(inputText) {
      ...
      return {
        ...
        guidance: "Practice strict integrity in all business dealings, promptly paying debts and wages, and avoiding exploitation of others' weakness."
      };
    }
  },
  {
    ...
    analyze(inputText) {
      ...
      return {
        ...
        guidance: "Cultivate truthfulness in all communication, avoiding exaggeration, deception, and harmful speech about others."
      };
    }
  },
  {
    ...
    analyze(inputText) {
      ...
      return {
        ...
        guidance: "Cultivate contentment with God's provision, rejoicing in others' blessings rather than envying their possessions or relationships."
      };
    }
  }
];
